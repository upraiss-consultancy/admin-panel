...
function DeletePackages({ handleClose, handleConfirm, open }) {
    ...
    return (
        ...
        >
            <DialogTitle id="alert-dialog-title">{"Are you sure you want to delte this package?"}</DialogTitle>
            <DialogContent>
                <DialogContentText id="alert-dialog-description">
                    If you delete this package, it cannot be undone. Are you sure you want to proceed?
                </DialogContentText>
                <DialogContentText>
...
export default memo(DeletePackages)